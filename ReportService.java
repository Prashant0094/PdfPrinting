...
public class ReportService {
	...
	public byte[] generateGasCuttingPdf(GasCuttingRequest dto, Map<String, Object> params) throws JRException, IOException {
	...
	public byte[] generateWeldingSafetyPdf(WeldingMachineRequest dto, Map<String, Object> params) throws JRException, IOException {
	...
	public byte[] generateLmraPdf(lmraRequest dto, Map<String, Object> params) throws JRException, IOException {
	    ...
	    JasperReport report = JasperCompileManager.compileReport(template);
	    JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(dto.getWorkerDetaiils());
	    JasperPrint print = JasperFillManager.fillReport(report, params, dataSource);
	    return JasperExportManager.exportReportToPdf(print);
	}
	
	public byte[] generateAppendix3Pdf(Appendix3Request dto, Map<String, Object> params) throws JRException, IOException {
	    ...
	    List<Appendix3Request.Appendix3List> participants = new ArrayList<>(dto.getList());
	...
	public byte[] generateToolBoxTalkPdf(ToolBoxTalkRequest dto, Map<String, Object> params) throws JRException, IOException {
	    ...
	    List<ToolBoxTalkRequest.TbtParticipants> participants = new ArrayList<>(dto.getParticipants());
	    while (participants.size() < 16) {
	        participants.add(new ToolBoxTalkRequest.TbtParticipants()); 
	    }
	...
	public byte[] generateAnnexure3Pdf(Annexure3Request dto) throws JRException, IOException {
	...
	public byte[] generateHitraPdf(AttachedHitraRequest dto, Map<String, Object> params) throws JRException, IOException {
